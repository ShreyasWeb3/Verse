  ...
  return (
    <div>
      <div className="flex">
        ...
        <select onChange={handleDropdown} className="absolute top-[3%] right-[10%]  bg-[#e50914] text-white p-2 rounded-md z-10 ">
          <option value="en" selected >English</option>
          <option value="hindi">Hindi</option>
          <option value="spanish">Spanish</option>
        </select>
      </div>
      <div className="fixed w-full h-full inset-0 bg-black opacity-90 ">
        <img
          src={bgImage}
